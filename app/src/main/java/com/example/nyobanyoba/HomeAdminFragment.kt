...
import com.example.nyobanyoba.databinding.FragmentHomeAdminBinding
...
class HomeAdminFragment : Fragment() {
    ...
    private val filmAdapter by lazy { FilmAdapterAdmin(mutableListOf()) }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding) {
            btnAddFilm.setOnClickListener{
                val intent = Intent(requireContext(), AddFilm::class.java)
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                if (response.isSuccessful) {
                    ...
                    Log.i("isi film blablabla", films.toString())
